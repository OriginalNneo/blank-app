        ...
        <form onSubmit={handleSubmit} className="space-y-2">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200 bg-white"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 text-sm text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200 bg-white"
